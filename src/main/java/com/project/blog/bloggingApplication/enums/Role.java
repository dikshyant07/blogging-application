package com.project.blog.bloggingApplication.enums;
...
import static com.project.blog.bloggingApplication.enums.Permission.*;

@RequiredArgsConstructor
public enum Role {
    USER(Set.of(USER_CREATE, USER_READ, USER_UPDATE, USER_DELETE)),

    MANAGER(Set.of(USER_CREATE, USER_READ, USER_UPDATE, USER_DELETE,
